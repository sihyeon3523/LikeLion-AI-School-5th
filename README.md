...
[프로젝트1. 코로나 확진자 수 변화에 따른 서울시 지하철 이용량 분석](#SEMI-PROJECT-1)
[웹 스크래핑 스터디. 채용 정보 스크래핑](#웹-스크래핑-스터디)
[프로젝트2. 타이타닉 생존자 예측](#SEMI-PROJECT-2)
[프로젝트3. 뉴스 토픽 분류 AI 모델 개발 및 적용](#Mid-Project)
[프로젝트4. 신용카드 사용자 연체 예측](#Mid-Project)
